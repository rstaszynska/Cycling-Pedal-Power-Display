...
function show_results() {
    ...
    if (mode === "Solo Mode" || mode === "Competition Mode") {
        ...
        var energyGeneratedkWh = bicyclePower / 3600000;
    }
    else {
        var energyGeneratedkWh = (bicyclePower + opponentScore) / 3600000;
    }
    ...
    if (energyDurationInSeconds > 60) {
        ...
        generatedEnergyDuration = minutes + " and " + seconds;
    }
    else {
        generatedEnergyDuration = energyDurationInSeconds;
    }
    ...
    if (timesUp) {
        ...
        if (mode === "Solo Mode") {
            ...
            subheading.innerHTML = "But you managed to generate " + ((bicyclePower + opponentScore) /  energyGoal * 100) + "% of the required energy!";
